...
$(document).ready(function(){
  ...
  // Add fonts
  $('head link').eq(0).before('<link href="https://fonts.googleapis.com/css?family=Roboto:100,300,400" rel="stylesheet">');
  $('head').append('<style type="text/css">.footer-menu a.menu-title,.is-loading,#cssmenu>ul>li>a,#cssmenu>ul>li>span.no-link,strong,body{font-family:\'Roboto\',sans-serif;font-weight:300}.title-summary .entry-title,h2.post-title a,h3.post-title a{font-family:\'Roboto\',Arial,sans-serif!important;font-weight:300}h1,h2,h3,h4,h5,h6{font-family:\'Roboto\',Arial,sans-serif;font-weight:300}</style>');
  // Add ads
