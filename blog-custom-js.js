...
$(document).ready(function(){
  ...
  if (domain == 'cacanh.blogsudo.com') {
    ...
    $('.breadcrumbs + .blog-posts #content-left').before('<div class="product-row" id="product-top"><div class="top-product-details clearfix"><iframe onclick="trackOutboundLinkWithLabel(\'\',\'Top Banner\',\'click\',\'Banner quảng cáo Lazada\');" src="https://lap.lazada.com/banner/dynamic.php?banner_id=589347eacf3a5&theme=1&p=1" frameborder="0" scrolling="no"></iframe></div></div>');
  }
  // Change price text
