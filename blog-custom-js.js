...
$(document).ready(function(){
  ...
  // Add fonts
  $('head link').eq(0).before('<link href="https://fonts.googleapis.com/css?family=Roboto|Roboto+Slab" rel="stylesheet">');
  $('head').append('<style type="text/css">.footer-menu a.menu-title,.is-loading,body,.r-content,#cssmenu>ul>li>a,#cssmenu>ul>li>span.no-link,strong{font-family:\'Roboto\',sans-serif}.title-summary .entry-title,h2.post-title a,h3.post-title a{font-family:\'Quicksand\',Arial,sans-serif!important}h1,h2,h3,h4,h5,h6{font-family:\'Quicksand\',Arial,sans-serif}</style>');
  // Add ads
