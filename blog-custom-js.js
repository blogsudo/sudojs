...
$(document).ready(function(){
  ...
  $('head').append('<style type="text/css">.footer-menu a.menu-title,.is-loading,body,.r-content,#cssmenu>ul>li>a,#cssmenu>ul>li>span.no-link,strong{font-family:\'Roboto\',sans-serif}.title-summary .entry-title,h3.post-title a{font-family:\'Roboto Slab\',sans-serif!important}h1,h2,h3,h4,h5,h6{font-family:\'Roboto Slab\',sans-serif}</style>');
  // Add ads
